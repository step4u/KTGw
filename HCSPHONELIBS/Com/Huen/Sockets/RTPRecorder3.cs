...
{
    public class RTPRecorder3 : IDisposable
    {
        ...
        public RTPRecorder3() : this (21010, 1)
        {
        }

        public RTPRecorder3(int port) : this (port, 1)
        {
        }

        public RTPRecorder3(int port, int threadcount)
        {
